...
$\alpha$ y $\beta$
$\beta$, y modelaremos los datos de manera que 
$\alpha$ sea común a todos los estudios, mientras que $\beta$ es específico para los estudios que incluyen diferentes niveles de dosis (estudios 11 y 12).
